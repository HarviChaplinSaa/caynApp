...
public class ListEventoPropioAdapter2 extends RecyclerView.Adapter {

    private List<Evento> mData;
    private OnItemClickListener OnItemClickListener;

    public ListEventoPropioAdapter2(List<Evento> listadoEventos) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mivista = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_evento_propio2, parent, false);
    ...
    public void setOnItemClickListener(ListEventoPropioAdapter2.OnItemClickListener onItemClickListener) {
