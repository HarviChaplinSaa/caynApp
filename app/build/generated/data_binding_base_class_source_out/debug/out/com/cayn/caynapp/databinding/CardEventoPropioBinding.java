...
public final class CardEventoPropioBinding implements ViewBinding {
  @NonNull
  ...
  private CardEventoPropioBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static CardEventoPropioBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CardEventoPropioBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.card_evento_propio, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CardEventoPropioBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CardEventoPropioBinding((LinearLayout) rootView, cvEventoPropio, ivEvento,
          tvNombreEvento);
    }
