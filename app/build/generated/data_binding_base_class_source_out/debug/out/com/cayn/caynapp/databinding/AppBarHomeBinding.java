...
public final class AppBarHomeBinding implements ViewBinding {
  ...
  private AppBarHomeBinding(@NonNull CoordinatorLayout rootView, @NonNull ImageButton btnDrawer,
      @NonNull ImageButton btnNotification, @NonNull Toolbar toolbar,
  ...
  public static AppBarHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AppBarHomeBinding((CoordinatorLayout) rootView, btnDrawer, btnNotification,
